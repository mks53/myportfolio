...
const ProjectCard = ({ name, description, image, skills, githubLink, liveLink }) => {
...
const Projects = () => {
  const projects = [
    {
      name: "SavvyESC",
      description: "A full-featured e-commerce website with product catalog, cart, and checkout functionality.",
    ...
    },
    {
      ...
      description: "Real-time weather application with detailed forecasts and interactive UI.",
